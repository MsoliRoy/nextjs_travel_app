...
export const Landing = (props: Props) => {
  ...
  return (
    <div className='flex items-end justify-between mx-2 sm:mx-5 lg:mx-[10%] xl:[15%] 2xl:[18%]'>
      ...
      <h1  className='font-heading text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold md:text-left text-center ' >Kenya</h1>
      <p className='w-full px-10 md:px-0 md:max-w-[450px]  text-sm font-medium text-primary/70 leading-7 my-5 md:text-justify text-center'>Kenya, where every step unveils a new wonder. Roar with lions in the Maasai Mara, 
      stand in awe at the towering Mount Kenya, and dance to the rhythm of Nairobi's vibrant streets. It's not just a destination; it's an adventure calling your name.</p>
