...
export const AccordionCard = (props: Props) => {
  return (
    ...
    <div className='flex items-start'>
     ...
     <h3 className='m-4 p-4 text-3xl font-bold text-primary hidden md:block'>Kes.{props.price}</h3>
    </div>
    ...
    <h3 className=' mx-2 text-xl font-bold text-primary block md:hidden'>Kes.{props.price}</h3>
    </div>
    </AccordionDetails>
  </Accordion>
  )
